...
VM     = {"hostname": "172.16.203.128", "username": "carl", "password": "159357"}
NEW_VM = {"hostname": "172.16.31.177", "username": "carl", "password": "159357"}
...
RK_FILES = [
    ...
    ("tools/configure_pwm_board.py",     "/opt/ros/rov_ros2_ws/tools/configure_pwm_board.py"),
    ("tools/configure_depth_sensor.py",  "/opt/ros/rov_ros2_ws/tools/configure_depth_sensor.py"),
    ("tools/probe_pwm_address.py",       "/opt/ros/rov_ros2_ws/tools/probe_pwm_address.py"),
]
...
VM_FILES = [
    ...
    ("vm/start_monitor.sh",              "/home/carl/rov_ros2_ws/start_monitor.sh"),
...
def main():
    ...
    ap.add_argument('--newvm',  action='store_true', help='部署到新 VM (172.16.31.177)')
    ap.add_argument('--all',    action='store_true', help='部署到全部')
    args = ap.parse_args()

    if args.vm or args.all:
        deploy(VM, "VM Ubuntu", VM_FILES)
    if args.newvm or args.all:
        deploy(NEW_VM, "新 VM Ubuntu", VM_FILES)

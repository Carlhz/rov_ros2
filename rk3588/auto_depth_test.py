...
class AutoDepthTest(Node):
    ...
    def _state_cb(self, msg: String):
        ...
        row = [
            ...
            round(data.get('ins_ax', 0), 4),
            round(data.get('ins_ay', 0), 4),
            round(data.get('ins_az', 0), 4),
            round(data.get('ins_wx', 0), 4),
            round(data.get('ins_wy', 0), 4),
            round(data.get('ins_wz', 0), 4),
            round(data.get('ins_ve', 0), 4),
            round(data.get('ins_vn', 0), 4),
            round(data.get('ins_vd', 0), 4),
